						...
						t * (64.0494725642004179 +
								t * (80.5635003792282196 +
										t * (64.9297873014508805 +
												t * (33.3013900893183129 +
														t * (9.61549304470339929 + t)))))));
	}
	else if (x < 40)
	{
		double t = 0.05 * x - 1;
						...
						t * (2224.50099218470684 +
								t * (2464.84669868672670 +
										t * (1392.55318009810070 +
												t * (346.597189642259199 +
														t * (22.7314613168652593 - t)))))));
	}
	else
	{
		double w = 1 / (x * x);
		...
		fd = -2 / std::sqrt(x) *
			 (1 + w *
					  (12264.3569103180524 +
						  s * (3204.34872454052352 +
								  s * (140.119604748253961 + s * .523918919699235590))) /
					  (9877.87829948067200 +
						  s * (2644.71979353906092 + s * (128.863768007644572 + s))));
	}
						...
						s * (299.962395449297620 +
								s * (207.640834087494249 +
										s * (92.0384803181851755 +
												s * (37.0164914112791209 +
														s * (7.88500950271420583 + s)))))));
	}
	else if (x < 2)
	{
		double t = .5 * x;
						 ...
						 t * (2568.48562814986046 +
								 t * (925.64264653555825 +
										 t * (574.23248354035988 +
												 t * (132.803859320667262 +
														 t * (29.8447166552102115 + t)))))));
	}
	else if (x < 5)
	{
						 ...
						 t * (3189.16066169981562 +
								 t * (1955.03979069032571 +
										 t * (828.000333691814748 +
												 t * (181.498111089518376 +
														 t * (32.0352857794803750 + t)))))));
	}
	else if (x < 10)
	{
		double t = .2 * x - 1;
								 ...
								 t * (2623.13060317199813 +
										 t * (1100.41355637121217 +
												 t * (267.469532490503605 +
														 t * (25.4207671812718340 +
																 t * .389887754234555773))))))) /
			 (273.407957792556998 +
				 t * (595.918318952058643 +
						 t * (605.202452261660849 +
								 t * (343.183302735619981 +
										 t * (122.187622015695729 +
												 t * (20.9016359079855933 + t))))));
	}
	else if (x < 20)
	{
		double t = .1 * x - 1;
						 ...
						 t * (7730.01593747621895 +
								 t * (6640.83376239360596 +
										 t * (3338.99590300826393 +
												 t * (860.499043886802984 +
														 t * (78.8565824186926692 + t)))))));
	}
	else if (x < 40)
	{
		double t = .05 * x - 1;
						 ...
						 t * (23268.1574325055341 +
								 t * (20477.2320119758141 +
										 t * (8726.52577962268114 +
												 t * (1647.42896896769909 +
														 t * (106.475275142076623 + t)))))));
	}
	else
	{
		double w = 1 / (x * x);
						...
						s * (323.9049470901941 +
								s * (218.89170769294024 +
										s * (102.31331350098315 +
												s * (36.319337289702664 +
														s * (8.3317401231389461 + s)))))));
	}
	else if (x < 2)
	{
		double t = .5 * x;
								 ...
								 t * (62766.3415600442563 +
										 t * (20093.6622609901994 +
												 t * (-2213.89084119777949 +
														 t * (-3901.66057267577389 -
																 t * 948.642895944858861))))))) /
			 (9488.61972919565851 +
				 t * (12514.8125526953073 +
						 t * (9903.44088207450946 +
								 t * (2138.15420910334305 +
										 t * (-528.394863730838233 +
												 t * (-661.033633995449691 +
														 t * (-51.4481470250962337 + t)))))));
	}
	else if (x < 10.)
	{
		double t = .2 * x - 1;
								 ...
								 t * (1.59630855803772449e6 +
										 t * (910818.935456183774 +
												 t * (326492.733550701245 +
														 t * (65507.2624972852908 +
																 t * 4809.45649527286889))))))) /
			 (39721.6641625089685 +
				 t * (86424.7529107662431 +
						 t * (88163.7255252151780 +
								 t * (50615.7363511157353 +
										 t * (17334.9774805008209 +
												 t * (2712.13170809042550 +
														 t * (82.2205828354629102 - t))))))) *
			 .999999999999999877;
	}
	else if (x < 20)
	{
								 ...
								 t * (2.03275937688070624e7 +
										 t * (7.41578871589369361e6 +
												 t * (1.21193113596189034e6 +
														 t * 63211.9545144644852)))))) /
			 (80492.7765975237449 +
				 t * (189328.678152654840 +
						 t * (151155.890651482570 +
								 t * (48146.3242253837259 +
										 t * (5407.08878394180588 +
												 t * (112.195044410775577 - t)))))) *
			 .999999999999999877;
	}
	else
	{
...
double inverse_fd_int_half(double x)
{
	...
	if (x < 1.17683303804380831)
	{
		...
		double z =
			...
			(156377.8333056294 +
				t * (48177.5705898287 +
						t * (5847.07218383812 + t * (335.3978079672194 + t * 7.84411868029912)))) /
			(117762.02905535089 +
				t * (-19007.26938370368 + t * (1376.2936928453140 + t * (-54.11372698481717 + t))));
		return std::log(z);
	}
	else if (x < 3.82993088157949761)
	{
		double t = .376917874490198033 * x - .443569407329314587;
		return (489.140447310410217 +
				   t * (5335.07269317261966 +
						   t * (20169.0736140442509 +
								   t * (35247.8115595510907 +
										   t * (30462.3668614714761 +
												   t * (12567.9032426128967 +
														   t * (2131.86789357398657 +
																   t * 93.6520172085419439))))))) /
			   (656.826207643060606 +
				   t * (4274.82831051941605 +
						   t * (10555.7581310151498 +
								   t * (12341.8742094611883 +
										   t * (6949.18854413197094 +
												   t * (1692.19650634194002 +
														   t * (129.221772991589751 + t)))))));
	}
	else if (x < 13.3854493161866553)
	{
		double t = .104651569335924949 * x - .400808277205416960;
		return (1019.84886406642351 +
				   t * (9440.18255003922075 +
						   t * (33947.6616363762463 +
								   t * (60256.7280980542786 +
										   t * (55243.0045063055787 +
												   t * (24769.8354802210838 +
														   t * (4511.77288617668292 +
																   t * 211.432806336150141))))))) /
			   (350.502070353586442 +
				   t * (2531.06296201234050 +
						   t * (6939.09850659439245 +
								   t * (9005.40197972396592 +
										   t * (5606.73612994134056 +
												   t * (1488.76634564005075 +
														   t * (121.537028889412581 + t)))))));
	}
	else if (x < 53.2408277860982205)
	{
		double t = .0250907164450825724 * x - .335850513282463787;
		return (11885.8779398399498 +
				   t * (113220.250825178799 +
						   t * (408524.373881197840 +
								   t * (695674.357483475952 +
										   t * (569389.917088505552 +
												   t * (206433.082013681440 +
														   t * (27307.2535671974100 +
																   t * 824.430826794730740))))))) /
			   (1634.40491220861182 +
				   t * (12218.1158551884025 +
						   t * (32911.7869957793233 +
								   t * (38934.6963039399331 +
										   t * (20038.8358438225823 +
												   t * (3949.48380897796954 +
														   t * (215.607404890995706 + t)))))));
	}
	else if (x < 188.411871723022843)
	{
		double t = .00739803415638806339 * x - .393877462475929313;
		return (11730.7011190435638 +
				   t * (99421.7455796633651 +
						   t * (327706.968910706902 +
								   t * (530425.668016563224 +
										   t * (438631.900516555072 +
												   t * (175322.855662315845 +
														   t * (28701.9605988813884 +
																   t * 1258.20914464286403))))))) /
			   (634.080470383026173 +
				   t * (4295.63159860265838 +
						   t * (10868.5260668911946 +
								   t * (12781.6871997977069 +
										   t * (7093.80732100760563 +
												   t * (1675.06417056300026 +
														   t * (125.750901817759662 + t)))))));
	}
	else
	{
		...
		double t = 1 - s;
		double z =
			(1.12813495144821933e7 + t * (420368.911157160874 + t * (1689.69475714536117 + t))) /

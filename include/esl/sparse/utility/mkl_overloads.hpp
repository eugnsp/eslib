...
#define ESL_MKL_SPARSE_EXPORT_CSR(T)                                                               \
	::sparse_status_t mkl_sparse_export_csr(::sparse_matrix_t, ::sparse_index_base_t&,             \
		MKL_UINT& n_rows, MKL_UINT& n_cols, MKL_UINT*& rows_start, MKL_UINT*& rows_end,            \
		MKL_UINT*& col_index, T*& values);

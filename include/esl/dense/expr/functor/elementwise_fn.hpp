...
{
public:
	static_assert(is_extent_dynamic_or_eq(ct_rows_value<Expr1>, ct_rows_value<Expr2>),
		"Incompatible extents");
	static_assert(is_extent_dynamic_or_eq(ct_cols_value<Expr1>, ct_cols_value<Expr2>),
		"Incompatible extents");
...
public:
	static void check_sizes(
		[[maybe_unused]] const Expr1& expr1, [[maybe_unused]] const Expr2& expr2)
	{

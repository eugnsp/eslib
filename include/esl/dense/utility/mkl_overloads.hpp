...
#define ESL_MKL_GEMV(T)                                                                            \
	void mkl_gemv(CBLAS_LAYOUT,                                                                    \
				  CBLAS_TRANSPOSE,                                                                 \
				  std::size_t m,                                                                   \
				  std::size_t n,                                                                   \
				  T alpha,                                                                         \
				  const T* data_a,                                                                 \
				  std::size_t lead_dim_a,                                                          \
				  const T* data_x,                                                                 \
				  std::size_t inc_x,                                                               \
				  T beta,                                                                          \
				  T* data_y,                                                                       \
	...
	void mkl_gemv(const std::size_t m,                                                             \
				  const std::size_t n,                                                             \
				  const T alpha,                                                                   \
				  const T* const data_a,                                                           \
				  const std::size_t lead_dim_a,                                                    \
				  const T* const data_x,                                                           \
				  const std::size_t inc_x,                                                         \
				  const T beta,                                                                    \
				  T* const data_y,                                                                 \
...
#define ESL_MKL_GEMM(T)                                                                            \
	void mkl_gemm(CBLAS_LAYOUT,                                                                    \
				  CBLAS_TRANSPOSE transp_a,                                                        \
				  CBLAS_TRANSPOSE transp_b,                                                        \
				  std::size_t m,                                                                   \
				  std::size_t n,                                                                   \
				  std::size_t k,                                                                   \
				  T alpha,                                                                         \
				  ...
				  T beta,                                                                          \
				  T* data_c,                                                                       \
				  std::size_t lead_dim_c);                                                         \
                                                                                                   \
	template<class Layout_tag, class Transp_a_tag, class Transp_b_tag>                             \
	void mkl_gemm(const std::size_t m,                                                             \
				  const std::size_t n,                                                             \
				  const std::size_t k,                                                             \
				  const T alpha,                                                                   \
				  const T* const data_a,                                                           \
				  const std::size_t lead_dim_a,                                                    \
				  const T* const data_b,                                                           \
...
#define ESL_MKL_OMATCOPY(T)                                                                        \
	void mkl_omatcopy(char layout,                                                                 \
					  ...
					  std::size_t lead_dim_b);                                                     \
                                                                                                   \
	template<class Layout_tag, class Transp_tag>                                                   \
	void mkl_omatcopy(const std::size_t rows,                                                      \
...
#define ESL_MKL_LAPACK_SYTRD(T)                                                                    \
	void mkl_lapack_sytrd(int layout,                                                              \
						  char up_lo,                                                              \
						  std::size_t n,                                                           \
						  T* data_a,                                                               \
						  std::size_t lead_dim_a,                                                  \
	...
	void mkl_lapack_sytrd(const std::size_t n,                                                     \
						  T* const data_a,                                                         \
						  const std::size_t lead_dim_a,                                            \
						  T* const data_d,                                                         \
						  T* const data_e,                                                         \

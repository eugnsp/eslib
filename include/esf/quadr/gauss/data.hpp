...
struct Gauss_data<0>
{
	static constexpr auto points = esu::make_array(
		Gauss_point{1, 0});
};
...
{
	static constexpr auto points = esu::make_array(
		Gauss_point{5 / 18,  -7.745966692414834e-1},
		Gauss_point{4. / 9,   0},
		Gauss_point{5. / 18,  7.745966692414834e-1});
};
...
{
	static constexpr auto points = esu::make_array(
		Gauss_point{1.7392742256872693e-1, -8.6113631159405302e-1},
...
{
	static constexpr auto points = esu::make_array(
		Gauss_point{1.1846344252809454e-1, -9.0617984593866396e-1},
		Gauss_point{2.3931433524968324e-1, -5.3846931010568289e-1},
		Gauss_point{128. / 450, 0},

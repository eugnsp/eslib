...
{
	static constexpr auto groups = std::make_tuple(
		Dunavant_points_group{1. / 3, 2. / 3, 1. / 6});
};
...
{
	static constexpr auto groups = std::make_tuple(
		Dunavant_points_group{-9. / 16, 1. / 3},
		Dunavant_points_group{25. / 48, .6, .2});
};
...
{
	static constexpr auto groups = std::make_tuple(
		Dunavant_points_group{.223381589678011, .108103018168070, .445948490915965},
...
{
	static constexpr auto groups = std::make_tuple(
		Dunavant_points_group{9. / 40, 1. / 3},
...
{
	static constexpr auto groups = std::make_tuple(
		Dunavant_points_group{.116786275726379, .501426509658179, .249286745170910},
		Dunavant_points_group{.050844906370207, .873821971016996, .063089014491502},
		Dunavant_points_group{.082851075618374, .053145049844817, .310352451033784, .636502499121399});
};
...
{
	static constexpr auto groups = std::make_tuple(
		Dunavant_points_group{-.149570044467682, 1. / 3},
		...
		Dunavant_points_group{.077113760890257, .048690315425316, .312865496004874, .638444188569810});
};
...
{
	static constexpr auto groups = std::make_tuple(
		Dunavant_points_group{.144315607677787, 1. / 3},
		...
		Dunavant_points_group{.027230314174435, .008394777409958, .263112829634638, .728492392955404});
};
...
{
	static constexpr auto groups = std::make_tuple(
		Dunavant_points_group{.097135796282799, 1. / 3},
		...
		Dunavant_points_group{.043283539377289, .036838412054736, .221962989160766, .741198598784498});
};
} // namespace esf::internal
